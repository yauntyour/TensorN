...
namespace TensorN
{
    namespace cuda
    {
        ...
        template <typename T>
        void add(const CudaTensor<T>& A, const CudaTensor<T>& B, CudaTensor<T>& C, cudaStream_t stream);

        template <typename T>
        void subtract(const CudaTensor<T>& A, const CudaTensor<T>& B, CudaTensor<T>& C);
        template <typename T>
        void subtract(const CudaTensor<T>& A, const CudaTensor<T>& B, CudaTensor<T>& C, cudaStream_t stream);

        template <typename T>
        void multiply(const CudaTensor<T>& A, const CudaTensor<T>& B, CudaTensor<T>& C);
        template <typename T>
        void multiply(const CudaTensor<T>& A, const CudaTensor<T>& B, CudaTensor<T>& C, cudaStream_t stream);

        template <typename T>
        void divide(const CudaTensor<T>& A, const CudaTensor<T>& B, CudaTensor<T>& C);
        template <typename T>
        void divide(const CudaTensor<T>& A, const CudaTensor<T>& B, CudaTensor<T>& C, cudaStream_t stream);

        template <typename T>
        void add_scalar(const CudaTensor<T>& A, T scalar, CudaTensor<T>& C);
        template <typename T>
        void add_scalar(const CudaTensor<T>& A, T scalar, CudaTensor<T>& C, cudaStream_t stream);

        template <typename T>
        void multiply_scalar(const CudaTensor<T>& A, T scalar, CudaTensor<T>& C);
        template <typename T>
        void multiply_scalar(const CudaTensor<T>& A, T scalar, CudaTensor<T>& C, cudaStream_t stream);
        ...
        template <typename T>
        void transpose(const CudaTensor<T>& A, CudaTensor<T>& C, cudaStream_t stream);

        template <typename T>
        void relu(const CudaTensor<T>& A, CudaTensor<T>& C);
        template <typename T>
        void relu(const CudaTensor<T>& A, CudaTensor<T>& C, cudaStream_t stream);
